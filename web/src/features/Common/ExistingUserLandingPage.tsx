...
export function ExistingUserLandingPage() {
	...
	return (
		<div className="container--existing p-d-flex p-flex-column p-p-6">
			...
			<div className="container--dashboard p-d-flex p-flex-row p-flex-wrap p-p-6">
				...
				<div className="dashboard-container container--notes">
					...
					<div className="text p-mb-4">
						You can now set which villagers are currently living on your island
						by selecting them in
						<a
					...
					<div className="text p-mb-4">
						So you've added some of your friends... now what? <br /> <br /> Now
						you can see if they have that genuine painting in Redd's shop, or
						that fossil you just dug up but already have. Clicking the
						<i className="pi pi-users icon--friends p-mx-2" />
						button on any item's card will show a list of your friends and
						whether or not they have that item, and you can send it their way to
						help them complete their museum collection!
					</div>
					<div className="subdivider p-mb-6" />
					...
					<div className="text p-mb-4">
						...
						well. There are lots of new additions coming down the road too, like
						viewing your friends' profiles and what they might be missing in
						their collections. Also, the ability to set which villagers you
					...
					<div className="text p-mb-4">
						...
						friends to (soon) see their progress alongside yours, like seeing if
						they need that piece of art in Redd's shop for example. More to come
						in the near future!
					</div>
					<div className="subdivider p-mb-6" />
					...
					<div className="text">
						...
						category. We've also added a bar at the top of the page to show your
						overall progress for all categories combined. Best of luck to you
						completionists and achievement hunters out there!
					</div>
				</div>
			</div>
		</div>
